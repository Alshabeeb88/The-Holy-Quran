<?php
$Q_W = array();
$Q_W['site_name'] = 'موقع القرآن الكريم';
$Q_W['site_description'] = 'تصفح واستمع للقرآن الكريم بأكثر من 40 لغة مع إمكانية تحميل السور والآيات بعدة صيغ.';
...
$Q_W['book_author'] = 'المؤلف';
$Q_W['book_translator'] = 'المترجم';
$Q_W['book_checker'] = 'المدقق/المراجع';
$Q_W['book_publisher'] = 'الناشر';
$Q_W['book_read'] = 'قراءة';
$Q_W['book_download'] = 'تحميل';
$Q_W['book_source'] = 'المصدر';
$Q_W['random_books'] = 'كتب عشوائيه';
$Q_W['books'] = 'الكتب';
$Q_W['book_categories'] = 'الأقسام';
...
$Q_W['more'] = 'المزيد';
$Q_W['home'] = 'الرئيسية';
$Q_W['languages'] = 'اللغات';
$Q_W['tfaseer'] = 'التفاسير';
$Q_W['page'] = 'الصفحة';
$Q_W['quran'] = 'القرآن الكريم';
$Q_W['no_data'] = 'لا يوجد بيانات';
$Q_W['books_in'] = 'كتب اللغة';
$Q_W['translation_in'] = 'ترجمة معاني القرآن الكريم باللغة %s';
$Q_W['quran_column'] = 3;
